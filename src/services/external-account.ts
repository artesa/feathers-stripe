...
export interface IExternalAccountService {
  _find: FindMethod<ParamsWithStripeQuery<Stripe.AccountListExternalAccountsParams & { account: string }>, Stripe.BankAccount | Stripe.Card>;
  _get: (id: string, params: ParamsWithStripeQuery<{ account: string }>) => Promise<Stripe.BankAccount | Stripe.Card>;
  _create: (data: Stripe.AccountCreateExternalAccountParams & { account: string }, params: ParamsWithStripe) => Promise<Stripe.BankAccount | Stripe.Card>;
  _update: (id: string, data: Stripe.AccountUpdateExternalAccountParams, params: ParamsWithStripeQuery<{ account: string }>) => Promise<Stripe.BankAccount | Stripe.Card>;
  _patch: (id: string, data: Stripe.AccountUpdateExternalAccountParams, params: ParamsWithStripeQuery<{ account: string }>) => Promise<Stripe.BankAccount | Stripe.Card>;
...
export class ExternalAccountService extends BaseService<IExternalAccountService> implements IExternalAccountService {
  _find (params: ParamsWithStripeQuery<Stripe.AccountListExternalAccountsParams & { account: string }>) {
  ...
  _create (data: Stripe.AccountCreateExternalAccountParams & { account: string }, params: ParamsWithStripe) {
  ...
  _update (id: string, data: Stripe.AccountUpdateExternalAccountParams, params: ParamsWithStripeQuery<{ account: string }>) {
    const { query, stripe } = this.filterParams(params);
    if (!query.account) {
      debug("Missing Stripe account id");
    }
  ...
  _patch (id: string, data: Stripe.AccountUpdateExternalAccountParams, params: ParamsWithStripeQuery<{ account: string }>) {
